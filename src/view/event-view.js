...
// Helper function to create the list of checked offers
function createCheckedOffersElement(offers, checkedOffers) {
  return `
    <ul class="event__selected-offers">
      ${offers.map((offer) => checkedOffers.includes(offer.id) ? `
...
// Helper function to create the event element
...
export default class EventView extends AbstractView {
  ...
  #rollupClickHandler = (evt) => {
    ...
    if(!this.#handleRollupClick) {
      throw new Error('this.#handleRollupClick not implemented!');
    }else{
  ...
  #favoriteClickHandler = (evt) => {
    ...
    if(!this.#handleFavoriteClick){
      throw new Error('this.#handleFavoriteClick not implemented!');
    }else{
